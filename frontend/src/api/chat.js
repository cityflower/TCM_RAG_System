 ...
 * @param {string|null} payload.image_base64 - Base64 编码的图片（可选）
 ...
 */
export function streamChat({ query, session_id = null, image_base64 = null }, onChunk, onReferences, onDone, onError) {
